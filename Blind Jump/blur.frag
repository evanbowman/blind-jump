...
void main() {
    ...
    vec4 color = vec4(0.0);
    color += texture2D(texture, textureCoordinates - 15.0 * blur_radius) * 0.0016;
    color += texture2D(texture, textureCoordinates - 14.0 * blur_radius) * 0.0016;
    color += texture2D(texture, textureCoordinates - 13.0 * blur_radius) * 0.0027;
    color += texture2D(texture, textureCoordinates - 12.0 * blur_radius) * 0.0045;
    color += texture2D(texture, textureCoordinates - 11.0 * blur_radius) * 0.0071;
    color += texture2D(texture, textureCoordinates - 10.0 * blur_radius) * 0.0108;
    color += texture2D(texture, textureCoordinates - 9.0 * blur_radius) * 0.0158;
