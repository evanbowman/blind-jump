...
FontController::FontController(sf::View fontView, float x, float y) {
	...
	heart.setScale(0.0005f * fontView.getSize().y, 0.0005f * fontView.getSize().y);
	...
	scoreText.setCharacterSize(0.032 * fontView.getSize().y);
	...
	healthNumText.setCharacterSize(0.032 * fontView.getSize().y);
